...
Sub ExportarParaDWG()
    ...
    If oDoc.DocumentType = kDrawingDocumentObject Then
        ...
        If addInFound Then
            ...
            UserForm1.Label6.Caption = "Finzalizado"
            UserForm1.Label7.Caption = "Arquivos PDF, DWF, DWG e CSV exportado com sucesso para C:\GD_GEM"
            'MsgBox "Arquivos PDF, DWF, DWG e CSV exportado com sucesso para C:\GD_GEM"
            ExpTodos = False
            Else
            UserForm1.Label4.Caption = "Gerando...OK"
            UserForm1.Label6.Caption = "Finzalizado"
            ...
            End If
        Else
            MsgBox "DWG Translator AddIn não encontrado."
        End If
    Else
        MsgBox "O documento ativo não é um documento de desenho."
    End If
End Sub
Sub ExportarParaDXF()
    ...
    ElseIf oDoc.DocumentType = kPartDocumentObject Then
        ...
        If ExpTodos = True Then
        UserForm1.Label3.Caption = "Gerando...OK"
        MsgBox "DXF da peça exportado com sucesso para " & sFilePath
        Else
        UserForm1.Label3.Caption = "Gerando...OK"
        End If
        
    Else
        MsgBox "O documento ativo não é um documento de desenho, montagem ou peça."
    End If
End Sub
...
Sub ExportarParaPDF()
   ...
   ' sOutputPath = sFolderPath & "PDFs\"
    ...
    ElseIf oDoc.DocumentType = kPartDocumentObject Then
        ...
        If ExpTodos = True Then
        UserForm1.Label2.Caption = "Gerando...OK"
        MsgBox "PDF da peça exportado com sucesso para " & sFilePath
        Else
        UserForm1.Label2.Caption = "Gerando...OK"
        End If
...
Public Sub WriteSheetMetalDXF()
        If TipoArquivo = "ipt" Then
            ...
            Else
             UserForm1.Label3.Caption = "Gerando...OK"
            MsgBox " DXF da peça exportado com sucesso com definiçoes do Flat Pattern para " & sFilePath
            End If
        ...
        Else
         UserForm1.Label3.Caption = "Gerando...OK"
        MsgBox "Este arquivo é um " & "." & TipoArquivo & " a exportação DXF é para peça planificada formato .ipt"
        End If
...
Sub ExportPartsListToCSV()
    ...
    If Not oDrawDoc.DocumentType = kDrawingDocumentObject Then
        MsgBox "Este código deve ser executado em um documento de desenho do Inventor.", vbExclamation
        Exit Sub
    End If
    ...
    If oDrawDoc.ActiveSheet.PartsLists.Count = 0 Then
        MsgBox "Nenhuma lista de peças encontrada na folha ativa.", vbExclamation
        Exit Sub
    End If
    ...
    Else
    UserForm1.Label5.Caption = "Gerando...OK"
    MsgBox "Lista de peças exportada com sucesso para " & filePath, vbInformation
    End If
End Sub
    ...
    If Not oDoc Is Nothing Then
        If oDoc.DocumentType = kDrawingDocumentObject Then
            ...
            If Not oDWFAddIn Is Nothing Then
                ...
                Else
                 MsgBox "Exportação concluída com sucesso! Arquivo salvo em: " & strFilePath
                End If
                
            Else
                MsgBox "O add-in de exportação DWF não está disponível."
            End If
        Else
            MsgBox "O documento ativo não é um arquivo de desenho (IDW)."
        End If
    Else
        MsgBox "Geração de Arquivos somente do Arquivo .IDW"
    End If
End Sub
